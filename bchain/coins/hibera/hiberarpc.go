...
// hiberaRPC is an interface to JSON-RPC bitcoind service
type hiberaRPC struct {
	*btc.BitcoinRPC
}
...
// NewhiberaRPC returns new hiberaRPC instance
func NewhiberaRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes hiberaRPC instance
func (z *hiberaRPC) Initialize() error {
	...
	z.Parser = NewhiberaParser(params, z.ChainConfig)
...
func (z *hiberaRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *hiberaRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (z *hiberaRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *hiberaRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
