...
func (z *solidusRPC) Initialize() error {
	...
	z.Parser = NewsolidusParser(params, z.ChainConfig)
...
func (z *solidusRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *solidusRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *solidusRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
