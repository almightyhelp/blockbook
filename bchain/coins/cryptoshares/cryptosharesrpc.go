...
// cryptosharesRPC is an interface to JSON-RPC bitcoind service
type cryptosharesRPC struct {
	*btc.BitcoinRPC
}
...
// NewcryptosharesRPC returns new cryptosharesRPC instance
func NewcryptosharesRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes cryptosharesRPC instance
func (z *cryptosharesRPC) Initialize() error {
	...
	z.Parser = NewcryptosharesParser(params, z.ChainConfig)
...
func (z *cryptosharesRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *cryptosharesRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (z *cryptosharesRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *cryptosharesRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
