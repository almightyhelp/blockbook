[![Go Report Card](https://goreportcard.com/badge/almightyhelp/blockbook)](https://goreportcard.com/report/almightyhelp/blockbook)
...
Please add your experience to this [issue](https://github.com/almightyhelp/blockbook/issues/43).
...
Check [this](https://github.com/almightyhelp/blockbook/issues/89) or [this](https://github.com/almightyhelp/blockbook/issues/147) issue for more info.

#### Running on Ubuntu

[This issue](https://github.com/almightyhelp/blockbook/issues/45) discusses how to run Blockbook on Ubuntu. If you have some additional experience with Blockbook on Ubuntu, please add it to [this issue](https://github.com/almightyhelp/blockbook/issues/45).

#### My coin implementation is reporting parse errors when importing blockchain

Your coin's block/transaction data may not be compatible with `BitcoinParser` `ParseBlock`/`ParseTx`, which is used by default. In that case, implement your coin in a similar way we used in case of [zcash](https://github.com/almightyhelp/blockbook/tree/master/bchain/coins/zec) and some other coins. The principle is not to parse the block/transaction data in Blockbook but instead to get parsed transactions as json from the backend.
