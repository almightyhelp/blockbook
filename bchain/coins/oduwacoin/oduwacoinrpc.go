...
func (z *oduwacoinRPC) Initialize() error {
	...
	z.Parser = NewoduwacoinParser(params, z.ChainConfig)
...
func (z *oduwacoinRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *oduwacoinRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (z *oduwacoinRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *oduwacoinRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
